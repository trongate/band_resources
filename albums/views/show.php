...
<div class="card">
    ...
    <div class="card-body">
        <?php 
        echo anchor('albums/manage', 'View All Albums', array("class" => "button alt"));
        echo anchor('albums/create/'.$update_id, 'Update Details', array("class" => "button"));
        $attr_delete = array( 
...
<div class="three-col">
    <div class="card record-details">
        ...
        <div class="card-body">
            <div><span>Album Title</span><span><?= $album_title ?></span></div>
            <div><span>Date Released</span><span><?= date('l jS F Y',  strtotime($date_released)) ?></span></div>
        ...
        <div class="card-body picture-preview">
            ...
            if ($draw_picture_uploader == true) {
                ...
                $picture_path = BASE_URL.segment(1).'/albums_module/images/albums_pics/'.$update_id.'/'.$picture;
            ?>
                <p class="text-center">
...
<div class="modal" id="delete-modal" style="display: none;">
    ...
    <div class="modal-body">
        <?= form_open('albums/submit_delete/'.$update_id) ?>
        <p>Are you sure?</p>
        <p>You are about to delete an Album record.  This cannot be undone.  Do you really want to do this?</p> 
        <?php 
